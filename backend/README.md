...
## Project Structure
    ...
    ├── testapiautoconnecto_59334  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_59334`
...
2. Clone this repo and `cd testapiautoconnecto_59334`
